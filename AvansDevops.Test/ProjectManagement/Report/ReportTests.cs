...
public class ReportTests
{
    ...
    public void SetUp()
    {
        ...
        var project = new Project("Test Project", scmService, developers, productOwner);
        ...
        _sprint = new Sprint(project, _backlog, leadDev, testers, scrumMaster, strategy, null);
    }
    ...
    public void Constructor_WithSprintAndTemplate_InitializesCorrectly()
    {
        ...
        // Act
        var report = new Report(_sprint, template);
    ...
    public void SaveToFile_WithPdfFormat_SavesAsText()
    {
        ...
        {
            // Act & Assert
            Assert.DoesNotThrow(() => Report.SaveToFile(content, tempFile, ReportFormat.Pdf));
            Assert.That(File.Exists(tempFile), Is.True);
        }
        finally
        {
    ...
    public void SaveToFile_WithPngFormat_SavesAsText()
    {
        ...
        {
            // Act & Assert
            Assert.DoesNotThrow(() => Report.SaveToFile(content, tempFile, ReportFormat.Png));
            Assert.That(File.Exists(tempFile), Is.True);
        }
        finally
        {
    ...
    public void SaveToFile_WithInvalidFormat_ThrowsException()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => 
            Report.SaveToFile("content", "file.txt", (ReportFormat)999));
    }
}